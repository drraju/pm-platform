...
export function ProjectWorkspaceBaselines({
  ...
  return (
    <SectionCard>
      <SectionHeader
        action={
          <ActionGroup wrap={false}>
            <CountBadge value={baselines.length} />
        ...
        description="Review immutable baseline snapshots and compare them with the current plan."
        layout="wide"
        title="Baselines"
      />

      {baselines.length === 0 ? (
        <EmptyState className="mt-5" variant="dashed">
