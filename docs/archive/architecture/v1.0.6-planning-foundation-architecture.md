...
- the end-user UI may label summary tasks as `Phase`
- the persisted domain model remains `task_kind = summary`
- API contracts continue to use `summary`
...
- summary rows are visually distinct and labeled as phases in the UI
